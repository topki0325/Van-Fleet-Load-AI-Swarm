...
async fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            frontend::cmd_get_providers,
            frontend::cmd_get_provider_config,
            frontend::cmd_set_default_provider,
            frontend::cmd_discover_nodes,
            frontend::cmd_list_discovered_nodes,
            frontend::cmd_create_swarm_group,
            frontend::cmd_join_swarm_group,
            frontend::cmd_leave_swarm_group,
            frontend::cmd_list_swarm_groups,
            frontend::cmd_get_group_members,
            frontend::cmd_request_resources,
            frontend::cmd_release_allocation,
            frontend::cmd_perform_health_check,
            frontend::cmd_set_remote_access,
            frontend::cmd_get_remote_access_status,
            frontend::cmd_set_balancing_strategy,
            frontend::cmd_get_balancing_strategy,
            frontend::cmd_create_resource_pool,
            frontend::cmd_list_resource_pools,
        ])
